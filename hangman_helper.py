...
def set_seed(a=None):
    """
    Sets a new seed for the random generator. You don't have to use this function,
     but it may help you in debugging Search on Google for more details about
      the seed of random generator in python, if it interests you.
